...
melbands_lst = [13, 15] #number of MFCC
...
k_lst = np.unique(np.logspace(start=1, stop=6, base=2, num=20, dtype=np.int64)) #number of neighbours for kNN

experiment = mlflow.set_experiment(experiment_name='Test')
